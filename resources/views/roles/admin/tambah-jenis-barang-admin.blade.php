        ...
        <div class="card-body">
            ...
            <form class="mt-4" action="{{ route('admin.tambah-jenis.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_barang" class="form-control" id="kode_barang" placeholder="11001"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Komputer"
                        value="{{ old('nama') }}">
                    @error('nama')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    <div class="d-flex">
                        ...
                        <input class="form-cuscontrol p-2 ms-3" style="width: 10%;" type="color" id="warna" name="warna">
                    </div>
                    @error('warna')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
